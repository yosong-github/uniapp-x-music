...
open class GenComponentsTabBarIndex : VueComponent {
    ...
    companion object {
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return utsMapOf("yoTabbar" to padStyleMapOf(utsMapOf("height" to "140rpx", "width" to "100%", "display" to "flex", "flexDirection" to "row", "justifyContent" to "space-between", "alignContent" to "center", "overflow" to "visible", "paddingBottom" to "var(safe-area-inset-bottom)", "position" to "relative")), "bg" to utsMapOf(".yoTabbar " to utsMapOf("position" to "absolute", "bottom" to "0%", "left" to "0%", "width" to "100%", "height" to "140rpx")), "tab-item" to utsMapOf(".yoTabbar " to utsMapOf("flex" to 1, "display" to "flex", "justifyContent" to "center", "alignItems" to "center")), "icon" to utsMapOf(".yoTabbar .tab-item " to utsMapOf("width" to "50rpx", "height" to "50rpx")), "search" to utsMapOf(".yoTabbar " to utsMapOf("height" to "140rpx", "width" to "140rpx", "position" to "relative", "top" to "-70rpx", "backgroundColor" to "#3e2ad1", "borderRadius" to "70rpx", "justifyContent" to "center", "alignItems" to "center")), "xxx" to utsMapOf(".yoTabbar .search " to utsMapOf("color" to "#ffffff")));
            }
